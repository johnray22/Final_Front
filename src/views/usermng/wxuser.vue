<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="OPENID" prop="id" sortable="custom" align="center" width="200px" :class-name="getSortClass('id')">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/webuser'
